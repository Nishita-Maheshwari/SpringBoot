...
public class ProductController
{
	...
	public String getProductsList(Model model, @RequestParam(defaultValue = "1") int page) throws Exception
	{
		...
		//System.out.println((double)total_products / PAGE_SIZE);
		//System.out.println(Math.floor((double)total_products / PAGE_SIZE));
		//System.out.println(Math.ceil((double)total_products / PAGE_SIZE));
